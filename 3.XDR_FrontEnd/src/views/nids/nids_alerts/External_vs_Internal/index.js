// ================================================================================================
//  File Name: external_vs_internal.js
//  Description: Details of the NIDS Alerts.
//  ----------------------------------------------------------------------------------------------
...
const ExternalVSInternal = ({ success }) => {
  ...
  const apiLogic = () => {
    setApiLoader(true)
    axios
      .get(`/threat-type-count-nids-alert?condition=${filterState.values ? filterState.values : 'last_1_hour'}`, { headers: { Authorization: token() } })
      .then((res) => {
        setApiLoader(false)
