// ================================================================================================
//  File Name: index.js
//  Description: Details of the NIDS Alerts IDS ( Target Host )
//  ----------------------------------------------------------------------------------------------
...
const TargetHostDetails = () => {
    ...
    const DetailsApiLogic = () => {
        setApiLoader(true)
        axios.get(`/nids-alert-freq-targetted-host?condition=${filterState.values ? filterState.values : 'last_1_hour'}`, { headers: { Authorization: token() } })
        .then(res => {
            setApiLoader(false)
...
export default TargetHostDetails