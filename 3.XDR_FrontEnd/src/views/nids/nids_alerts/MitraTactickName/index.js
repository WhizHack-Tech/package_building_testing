...
const MiteTactick = () => {
 ...
 const ChartApiLogic = () => {
    ...
    axios.get(`/nids-alert-mitre-tactics-bar-chart?condition=${filterState.values ? filterState.values : 'last_1_hour'}`, { headers: { Authorization: token() } })
      .then(res => {
        setApiLoader(false)
