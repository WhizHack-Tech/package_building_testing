// ==============================================================================================
//  File Name: nids_charts.js
//  Description: Details of the breadcrumbs NIDS Chart filter by date component.
// ----------------------------------------------------------------------------------------------
...
const BreadCrumbs = props => {
  ...
  const filterStore = useSelector((state => state.dashboard_chart))
  ...
  const applyReload = () => {
    ...
    if (reloadVal !== 'off') {
      ...
      setIntervalFun = setInterval(() => {
        console.log(filters, 'filterBread')
