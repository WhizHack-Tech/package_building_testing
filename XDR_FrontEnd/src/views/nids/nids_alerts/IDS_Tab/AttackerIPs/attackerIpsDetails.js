// ================================================================================================
//  File Name: attackerIpsDetails.js
//  Description: Details of the NIDS Alerts IDS ( Attacker IPs ).
//  ----------------------------------------------------------------------------------------------
...
const AttackerIpsDetails = () => {
    ...
    const DetailsApiLogic = () => {
        setApiLoader(true)
        axios.get(`http://127.0.0.1:8000/attacker-ip-line-table?past_time=${searchParams.get('past_time')}&current_time=${searchParams.get('current_time')}&name=${searchParams.get('name')}`)
            .then(res => {
                setApiLoader(false)
    ...
    return (
        <Card className='overflow-hidden'>
             <CardHeader className='flex-md-row flex-column align-md-items-center align-items-start border-bottom'>
                <CardTitle tag='h4'> {t("Source IPs")} : {searchParams.get("name")}</CardTitle>
            ...
            {/* <CardHeader>
                <CardTitle>
                    {t('Attacker IPs')} {searchParams.get('name')}
                </CardTitle>
            </CardHeader> */}
