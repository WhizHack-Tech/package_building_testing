// ================================================================================================
//  File Name: index.js
//  Description: Details of the NIDS Alerts ML & DL ( Attacked Service Details )
//  ----------------------------------------------------------------------------------------------
...
const AttackerServiceTable = () => {
    ...
    const DetailsApiLogic = () => {
        setApiLoader(true)
        axios.get(`/nids-alert-ml-attacked-service?condition=${filterState.values ? filterState.values : 'last_1_hour'}`, { headers: { Authorization: token() } })
            .then(res => {
                setApiLoader(false)
