// ================================================================================================
//  File Name: index.js
//  Description: Details of the NIDS Alerts ML & DL ( Target Frequency Host Details )
//  ----------------------------------------------------------------------------------------------
...
const TargetFrequencyHost = () => {
    ...
    const DetailsApiLogic = () => {
        setApiLoader(true)
        axios.get(`/nids-alert-ml-freq-trgted-host?condition=${filterState.values ? filterState.values : 'last_1_hour'}`, { headers: { Authorization: token() } })
            .then(res => {
                setApiLoader(false)
...
export default TargetFrequencyHost