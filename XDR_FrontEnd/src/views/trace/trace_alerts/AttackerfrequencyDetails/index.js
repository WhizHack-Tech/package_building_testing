// ================================================================================================
//  File Name: index.js
//  Description: Details of the Trace ( Alerts ( Attacker Frequency Details )).
//  ----------------------------------------------------------------------------------------------
...
const AttackerFrequencyDetails = () => {
  ...
  const DetailsApiLogic = () => {
    setApiLoader(true)
    axios.get(`/freq-attacker-trace-alert?condition=${filterState.values ? filterState.values : 'last_1_hour'}`, { headers: { Authorization: token() } })
      .then(res => {
        setApiLoader(false)
