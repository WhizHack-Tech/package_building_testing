...
def hids_incident_top_tactics_func(agent_id,indice_name,current_time,past_time, location_id, plan_id):
...
def hids_incident_rule_level_byattack_func(agent_id,indice_name,current_time,past_time, location_id, plan_id):
...
def hids_incident_rule_level_by_tactics_func(agent_id,indice_name,current_time,past_time, location_id, plan_id):
...
def hids_incident_alerts_evolution_overtime_func(agent_id,indice_name,current_time,past_time, condition, location_id, plan_id):
...
def hids_incident_mitre_attackby_tactic_func(agent_id,indice_name,current_time,past_time, location_id, plan_id):
...
def hids_incident_mitre_alert_evolution_over_time(request):
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def hids_incident_mitre_alert_evolution_over_time_table(request):

    parameters = pre_check_parameters(
        request, indice="hids_incident_agent", type="table", rule="rule_mitre_tactic"
    )
    if parameters.pop("error"):
        return Response(parameters)
    else:
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def hids_incident_mitre_attack_by_tactic(request):

    parameters = pre_check_parameters(
        request, indice="hids_incident_agent", type="bar_chart"
    )
    if parameters.pop("error"):
        return Response(parameters)
    else:
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def hids_incident_mitre_attack_by_tactic_table(request):
