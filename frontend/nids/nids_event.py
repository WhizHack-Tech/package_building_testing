#  ==================================================================================================================
#  File Name: nids_event.py
#  Description: It contains all the code for each chart on NIDS Events page under NIDS tab on Client Dashboard.
#  Active URL: https://xdr-demo.zerohack.in/nids/events
...
#1.a Critical Threats
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_event_critical_threats(request):
    ...
    indice_name = index_name_dict.get('nids_event_agent')
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_event_critical_threats_table(request):
    location_id = request.user.location_id.id
    plan_idObj = request.user.location_id.activated_plan_id
...
#2.a Lateral Movement chart
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_event_lateral_mov(request):
    condition = request.GET.get('condition')
    location_id = request.user.location_id.id
    plan_idObj = request.user.location_id.activated_plan_id
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_event_lateral_mov_table(request):
    location_id = request.user.location_id.id
    plan_idObj = request.user.location_id.activated_plan_id
...
#3.a Internal Compromised Machine chart
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_event_int_compr(request):
    condition = request.GET.get('condition')
    location_id = request.user.location_id.id
    plan_idObj = request.user.location_id.activated_plan_id
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_event_int_compr_table(request):
    location_id = request.user.location_id.id
    plan_idObj = request.user.location_id.activated_plan_id
...
#4.a External Attack chart
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_event_ext(request):
    condition = request.GET.get('condition')
    location_id = request.user.location_id.id
    plan_idObj = request.user.location_id.activated_plan_id
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_event_ext_table(request):
    location_id = request.user.location_id.id
    plan_idObj = request.user.location_id.activated_plan_id
...
# note: changing all queries bcz type_of_threat column not present in event indice currently
# 5.a. Card Name: Attack Frequency
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_event_attack_frequency(request):
    condition = request.GET.get('condition')
    location_id = request.user.location_id.id
    plan_idObj = request.user.location_id.activated_plan_id
    ...
    sql_query = f"SELECT attack_epoch_time FROM {indice_name}-* WHERE (attack_epoch_time >= {past_time} AND attack_epoch_time <= {current_time}) AND ids_threat_class IS NOT NULL "+platform_query+s1+s2+f" ORDER BY attack_epoch_time DESC limit 200000;"
...
# 5.b. Attack Frequency Table
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_event_attack_freq_table(request):
    ...
    # sql query to get table data
    table_query = f"SELECT platform, attacker_ip, attacker_mac, attack_timestamp, attacker_port, target_port, target_ip, geoip_city, geoip_country_name, geoip_asn_name FROM {indice_name}-* WHERE (attack_epoch_time >= {past_time} AND attack_epoch_time <= {current_time}) AND platform = '{platform_name}' "+s1+s2+f" AND ids_threat_class IS NOT NULL ORDER BY attack_epoch_time DESC limit 200000;"
...
#6.a Card Name: Attacker IP (Line chart)
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_event_line_chart(request):
    condition = request.GET.get('condition')
    location_id = request.user.location_id.id
    plan_idObj = request.user.location_id.activated_plan_id
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_event_line_table(request):
...
# 7.a Card Name: Service Names (Bar chart on service_name column)
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_event_service_name_bar_chart(request):
    condition = request.GET.get('condition')
    location_id = request.user.location_id.id
    plan_idObj = request.user.location_id.activated_plan_id
...
# 7.b Bar chart on service_name column--Table
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_event_service_name_bar_table(request):
...
# 8.a Card Name: Top Attacker Port (Pie chart on attacker_port column)
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_event_attacker_port_pie_chart(request):
    condition = request.GET.get('condition')
    location_id = request.user.location_id.id
    plan_idObj = request.user.location_id.activated_plan_id
...
# 8.b Pie chart on attacker_port column--Table
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_event_attacker_port_pie_table(request):
...
# 9.a Bar chart on ids_threat_class column
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_event_ids_class_bar_chart(request):
    condition = request.GET.get('condition')
    location_id = request.user.location_id.id
    plan_idObj = request.user.location_id.activated_plan_id
    ...
    if run_sql_query.get("total") not in exclude_values:
        threat_class, threat_count = map(list, zip(*run_sql_query['datarows']))
        bar_chart_dict = {"series": threat_count, "labels": threat_class}
        
        filter_list = []
        for i,n in enumerate(threat_class):
        ...
        return Response({"message_type":"success", "bar_chart":bar_chart_dict, "filter":filter_list})
    else:
        return Response({"message_type":"d_not_f"})

# 9.b Bar chart on ids_threat_class column--Table
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_event_ids_class_bar_table(request):
...
# 10.a Bar chart on malware_type column
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_event_malware_type_bar_chart(request):
    condition = request.GET.get('condition')
    location_id = request.user.location_id.id
    plan_idObj = request.user.location_id.activated_plan_id
...
# 10.b Bar chart on malware_type column--Table
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_event_malware_type_bar_table(request):
...
# 11.a Bar chart on mitre_tactics_name column
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_event_mitre_tactics_bar_chart(request):
    condition = request.GET.get('condition')
    location_id = request.user.location_id.id
    plan_idObj = request.user.location_id.activated_plan_id
...
# 11.b Bar chart on mitre_tactics_name column--Table
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_event_mitre_tactics_bar_table(request):
...
# 12.a Bar chart on mitre_techniques_name column
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_event_mitre_techniq_bar_chart(request):
    condition = request.GET.get('condition')
    location_id = request.user.location_id.id
    plan_idObj = request.user.location_id.activated_plan_id
...
# 12.b Bar chart on mitre_techniques_name column--Table
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_event_mitre_techniq_bar_table(request):
...
# 13.a. Card Name: Detected Threat Type card  -----(i).ML (ii).DL (iii). IDS
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_event_detected_threat_type(request):
    condition = request.GET.get('condition')
    location_id = request.user.location_id.id
    plan_idObj = request.user.location_id.activated_plan_id
    ...
    dl_sql_query = f"SELECT platform, dl_threat_class, count(dl_threat_class) count FROM {indice_name}-* WHERE dl_threat_class IS NOT NULL AND dl_threat_class !='undefined class' and (attack_epoch_time >= {past_time} AND attack_epoch_time <= {current_time}) AND ids_threat_class IS NOT NULL "+platform_query+s1+s2+f" GROUP BY platform, dl_threat_class ORDER BY count desc LIMIT 7;"
    
    ids_sql_query = f"SELECT platform, ids_threat_class, count(ids_threat_class) count FROM {indice_name}-* WHERE ids_threat_class IS NOT NULL AND ids_threat_class !='undefined class' and (attack_epoch_time >= {past_time} AND attack_epoch_time <= {current_time}) "+platform_query+s1+s2+f" GROUP BY platform, ids_threat_class ORDER BY count desc LIMIT 7;"
...
# 13.b. Detected Threat Type card---Table
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_event_detected_threat_type_table(request):
    ...
    ids_threat_class_name = request.GET.get('name')
    if ids_threat_class_name is None:
    ...
    if threat_class_type in threat_class_type_dict:
        ...
        if run_sql.get("total") not in exclude_values:
            ...
            return Response({"message_type":"success", "count":len(table_query_list), f"{threat_class_type_dict[threat_class_type]}":ids_threat_class_name,"table":table_query_list})
        else:
            return Response({"message_type":"d_not_f"})
    else:
        return Response({"message_type": "d_not_f", "errors": "type_not_f"})
...
# 14.a. Card Name: Attacker Geo-Locations
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_event_geolocation(request):
    condition = request.GET.get('condition')
    location_id = request.user.location_id.id
    plan_idObj = request.user.location_id.activated_plan_id
...
# 14.b. geolocation Table
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_event_geolocation_table(request):
...
# 15.a Card Name: Top Source Attack Countries (Bar chart on geoip_country_name column)
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_event_country_bar_chart(request):
    condition = request.GET.get('condition')
    location_id = request.user.location_id.id
    plan_idObj = request.user.location_id.activated_plan_id
...
# 15.b Bar chart on geoip_country_name column--Table
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_event_country_bar_table(request):
...
# 16.a Card Name: Top Attacker City (Pie chart on geoip_city column)
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_event_city_pie_chart(request):
    condition = request.GET.get('condition')
    location_id = request.user.location_id.id
    plan_idObj = request.user.location_id.activated_plan_id
    ...
    sql = f"SELECT geoip_city, COUNT(geoip_city) FROM {indice_name}-* WHERE geoip_city NOT LIKE 'NA' AND (attack_epoch_time >= {past_time} AND attack_epoch_time <= {current_time}) AND ids_threat_class IS NOT NULL "+platform_query+s1+s2+f" GROUP BY geoip_city ORDER BY COUNT(geoip_city) desc LIMIT 7;"
...
# 16.b Pie chart on geoip_city column--Table
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_event_city_pie_table(request):
    city_name = request.GET.get('geoip_city')
    if city_name is None:
        return Response({"message_type": "d_not_f", "errors": "geoip_city_not_found"})
...
# 17.a Card Name: Attacker ASN (Bar chart on geoip_asn_name column)
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_event_asn_bar_chart(request):
    condition = request.GET.get('condition')
    location_id = request.user.location_id.id
    plan_idObj = request.user.location_id.activated_plan_id
...
# 17.b Bar chart on geoip_asn_name column--Table
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_event_asn_bar_table(request):
...
# 18.a Card Name: Target IP (Pie chart on target_ip column)
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_event_target_ip_pie_chart(request):
    condition = request.GET.get('condition')
    location_id = request.user.location_id.id
    plan_idObj = request.user.location_id.activated_plan_id
    ...
    sql = f"SELECT target_ip, COUNT(target_ip) FROM {indice_name}-* WHERE (attack_epoch_time >= {past_time} AND attack_epoch_time <= {current_time}) AND ids_threat_class IS NOT NULL AND target_ip IS NOT NULL "+platform_query+s1+s2+f" GROUP BY target_ip ORDER BY COUNT(target_ip) desc LIMIT 7;"
...
# 18.b Pie chart on target_ip column--Table
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_event_target_ip_table(request):
...
# 19.a Card Name: Target MAC (Pie chart on target_mac column)
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_event_target_mac_pie_chart(request):
    condition = request.GET.get('condition')
    location_id = request.user.location_id.id
    plan_idObj = request.user.location_id.activated_plan_id
...
# 19.b Pie chart on target_mac column--Table
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_event_target_mac_table(request):
...
# 20.a Card Name: Target Port (Pie chart on target_port column)
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_event_target_port_pie_chart(request):
    condition = request.GET.get('condition')
    location_id = request.user.location_id.id
    plan_idObj = request.user.location_id.activated_plan_id
...
# 20.b Pie chart on target_port column--Table
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_event_target_port_table(request):
...
# 21. Card Name: Most Attacked Host, Card Name: Target Host --only table
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_event_freq_targetted_host(request):
    condition = request.GET.get('condition')
    past_time, current_time = calculate_start_end_time(condition)
    ...
    sql_query = f"SELECT target_ip,target_mac, count(target_ip) target_ip_count FROM {indice_name}-* WHERE target_ip IS NOT NULL "+platform_query+s1+s2+f" AND attack_epoch_time >= {past_time} AND attack_epoch_time <= {current_time} AND ids_threat_class IS NOT NULL GROUP BY target_ip,target_mac ORDER BY target_ip_count DESC LIMIT 50;"
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_event_freq_attacker(request):
    condition = request.GET.get('condition')
    past_time, current_time = calculate_start_end_time(condition)
    ...
    sql_query = f"SELECT attacker_ip,target_mac, count(attacker_ip) attacker_ip_count FROM {indice_name}-* WHERE attacker_ip IS NOT NULL "+platform_query+s1+s2+f" AND attack_epoch_time >= {past_time} AND attack_epoch_time <= {current_time} AND ids_threat_class IS NOT NULL GROUP BY attacker_ip,target_mac ORDER BY attacker_ip_count DESC LIMIT 50;"
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_event_attacked_service_details(request):
    condition = request.GET.get('condition')
    past_time, current_time = calculate_start_end_time(condition)
    ...
    sql_query = f"SELECT attacker_ip, service_name, count(*) service_name_count FROM {indice_name}-* WHERE attacker_ip IS NOT NULL AND service_name NOT LIKE 'NA' "+platform_query+s1+s2+f" AND attack_epoch_time >= {past_time} AND attack_epoch_time <= {current_time} AND ids_threat_class IS NOT NULL GROUP BY attacker_ip,service_name ORDER BY service_name_count DESC LIMIT 50;"
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_event_ml_detected_threat(request):
    condition = request.GET.get('condition')
    location_id = request.user.location_id.id
    plan_idObj = request.user.location_id.activated_plan_id
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_event_ml_detected_threat_table(request):
    threat_class_type = request.GET.get('type')
    if threat_class_type is None:
        return Response({"message_type": "d_not_f", "errors": "type_not_f"})    
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_event_ml_map_table(request):
    city_name = request.GET.get('geoip_city')
    if city_name is None:
        return Response({"message_type": "d_not_f", "errors": "geoip_city_not_found"})
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_event_ml_cntry_bar(request):
    condition = request.GET.get('condition')
    location_id = request.user.location_id.id
    plan_idObj = request.user.location_id.activated_plan_id
    ...
    sql = f"SELECT geoip_country_name, COUNT(geoip_country_name) FROM {indice_name}-* WHERE (attack_epoch_time >= {past_time} AND attack_epoch_time <= {current_time}) AND ids_threat_class IS NULL AND geoip_country_name IS NOT NULL AND ((ml_accuracy>{accuracy1} AND ml_accuracy<={accuracy2}) OR (dl_accuracy>{accuracy1} AND dl_accuracy<={accuracy2})) "+platform_query+s1+s2+f" GROUP BY geoip_country_name ORDER BY COUNT(geoip_country_name) desc LIMIT 7;"
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_event_ml_cntry_bar_table(request):
    country_name = request.GET.get('geoip_country_name')
    if country_name is None:
        return Response({"message_type": "d_not_f", "errors": "geoip_country_name_not_found"})
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_event_ml_asn_bar(request):
    condition = request.GET.get('condition')
    location_id = request.user.location_id.id
    plan_idObj = request.user.location_id.activated_plan_id
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_event_ml_asn_table(request):
    asn_name = request.GET.get('geoip_asn_name')
    if asn_name is None:
        return Response({"message_type": "d_not_f", "errors": "geoip_asn_name_not_found"})
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_event_ml_city_pie(request):
    condition = request.GET.get('condition')
    location_id = request.user.location_id.id
    plan_idObj = request.user.location_id.activated_plan_id
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_event_ml_city_table(request):
    city_name = request.GET.get('geoip_city')
    if city_name is None:
        return Response({"message_type": "d_not_f", "errors": "geoip_city_not_found"})
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_event_ml_target_ip_pie(request):
    condition = request.GET.get('condition')
    location_id = request.user.location_id.id
    plan_idObj = request.user.location_id.activated_plan_id
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_event_ml_target_ip_table(request):
    target_ip = request.GET.get('target_ip')
    if target_ip is None:
        return Response({"message_type": "d_not_f", "errors": "target_ip_not_found"})
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_event_ml_target_mac_pie_chart(request):
    condition = request.GET.get('condition')
    location_id = request.user.location_id.id
    plan_idObj = request.user.location_id.activated_plan_id
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_event_ml_target_mac_table(request):
    target_mac = request.GET.get('target_mac')
    if target_mac is None:
        return Response({"message_type": "d_not_f", "errors": "target_mac_not_found"})
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_event_ml_target_port_pie(request):
    condition = request.GET.get('condition')
    location_id = request.user.location_id.id
    plan_idObj = request.user.location_id.activated_plan_id
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_event_ml_target_port_table(request):
    target_port = request.GET.get('target_port')
    if target_port is None:
        return Response({"message_type": "d_not_f", "errors": "target_port_not_found"})
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_event_ml_freq_trgted_host(request):
    condition = request.GET.get('condition')
    past_time, current_time = calculate_start_end_time(condition)
...
# 33 ML DL- Card Name: Frequent Attacker Details --only table
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_event_ml_freq_attacker(request):
    condition = request.GET.get('condition')
    past_time, current_time = calculate_start_end_time(condition)
...
# 34 ML DL- Card Name: Attacked Services --only table
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_event_ml_attacked_service_details(request):
    condition = request.GET.get('condition')
    past_time, current_time = calculate_start_end_time(condition)
