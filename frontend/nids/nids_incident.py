#  ==============================================================================================================================
#  File Name: nids_incident.py
#  Description: It contains all the code for each chart on NIDS Incidents page under NIDS tab on Client Dashboard.
#  Active URL: https://xdr-demo.zerohack.in/nids/incidents
...
from ..opensearch_config import query, opensearch_conn_using_db
from ..time_filter_on_queries import calculate_start_end_time
...
def nids_incident_critical_threats(request):
    ...
    indice_name = index_name_dict.get('nids_incident_agent')
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_incident_critical_threats_table(request):
    location_id = request.user.location_id.id
    plan_idObj = request.user.location_id.activated_plan_id
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_incident_lateral_mov(request):
    condition = request.GET.get('condition')
    location_id = request.user.location_id.id
    plan_idObj = request.user.location_id.activated_plan_id
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_incident_lateral_mov_table(request):
    location_id = request.user.location_id.id
    plan_idObj = request.user.location_id.activated_plan_id
...
#3.a Card Name: Internal Attacks (here type_Of_threat = Internal Compromised Machine is filtered)
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_incident_int_compr(request):
    condition = request.GET.get('condition')
    location_id = request.user.location_id.id
    plan_idObj = request.user.location_id.activated_plan_id
...
#3.b Internal Attacks card Table
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_incident_int_compr_table(request):
    location_id = request.user.location_id.id
    plan_idObj = request.user.location_id.activated_plan_id
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_incident_ext_table(request):
    location_id = request.user.location_id.id
    plan_idObj = request.user.location_id.activated_plan_id
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_incident_attack_frequency(request):
    condition = request.GET.get('condition')
    location_id = request.user.location_id.id
    plan_idObj = request.user.location_id.activated_plan_id
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_incident_attack_freq_table(request):
...
#6.a Card Name: Attacker IPs (Line chart)
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_incident_line_chart(request):
    condition = request.GET.get('condition')
    location_id = request.user.location_id.id
    plan_idObj = request.user.location_id.activated_plan_id
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_incident_line_table(request):
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_incident_service_name_bar_chart(request):
    condition = request.GET.get('condition')
    location_id = request.user.location_id.id
    plan_idObj = request.user.location_id.activated_plan_id
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_incident_service_name_bar_table(request):
...
# 8.a Card Name:  Top Attacker Port (Bar chart on attacker_port column)
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_incident_attacker_port_bar_chart(request):
    condition = request.GET.get('condition')
    location_id = request.user.location_id.id
    plan_idObj = request.user.location_id.activated_plan_id
...
# 8.b Bar chart on attacker_port column--Table
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_incident_attacker_port_bar_table(request):
...
# 9.a Card Name: Threat Class (Bar chart on ids_threat_class column)
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_incident_ids_class_bar_chart(request):
    condition = request.GET.get('condition')
    location_id = request.user.location_id.id
    plan_idObj = request.user.location_id.activated_plan_id
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_incident_ids_class_bar_table(request):
...
# 10.a Card Name: Malware Threats Type (Pie chart on malware_type column)
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_incident_malware_type_pie_chart(request):
    condition = request.GET.get('condition')
    location_id = request.user.location_id.id
    plan_idObj = request.user.location_id.activated_plan_id
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_incident_malware_type_pie_table(request):
...
# 11.a Card Name: Mitre Att&ck Tactics (Pie chart on mitre_tactics_name column)
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_incident_mitre_tactics_pie_chart(request):
    condition = request.GET.get('condition')
    location_id = request.user.location_id.id
    plan_idObj = request.user.location_id.activated_plan_id
...
# 11.b Pie chart on mitre_tactics_name column--Table
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_incident_mitre_tactics_pie_table(request):
...
# 12.a Card Name: Mitre Att&ck Techniques (Pie chart on mitre_techniques_name column)
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_incident_mitre_techniq_pie_chart(request):
    condition = request.GET.get('condition')
    location_id = request.user.location_id.id
    plan_idObj = request.user.location_id.activated_plan_id
...
# 12.b Pie chart on mitre_techniques_name column--Table
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_incident_mitre_techniq_pie_table(request):
...
# 13.a. Card Name: Detected Threat Type  -----(i).ML (ii).DL (iii). IDS
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_incident_detected_threat_type(request):
    condition = request.GET.get('condition')
    location_id = request.user.location_id.id
    plan_idObj = request.user.location_id.activated_plan_id
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_incident_detected_threat_type_table(request):
    threat_class_type = request.GET.get('type')
    if threat_class_type is None:
        return Response({"message_type": "d_not_f", "errors": "threat_type_not_f"})    
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_incident_geolocation(request):
    condition = request.GET.get('condition')
    location_id = request.user.location_id.id
    plan_idObj = request.user.location_id.activated_plan_id
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_incident_geolocation_table(request):
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_incident_country_bar_chart(request):
    condition = request.GET.get('condition')
    location_id = request.user.location_id.id
    plan_idObj = request.user.location_id.activated_plan_id
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_incident_country_bar_table(request):
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_incident_city_pie_chart(request):
    condition = request.GET.get('condition')
    location_id = request.user.location_id.id
    plan_idObj = request.user.location_id.activated_plan_id
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_incident_city_pie_table(request):
    city_name = request.GET.get('geoip_city')
    if city_name is None:
        return Response({"message_type": "d_not_f", "errors": "geoip_city_not_found"})
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_incident_asn_bar_chart(request):
    condition = request.GET.get('condition')
    location_id = request.user.location_id.id
    plan_idObj = request.user.location_id.activated_plan_id
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_incident_asn_bar_table(request):
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_incident_target_ip_pie_chart(request):
    condition = request.GET.get('condition')
    location_id = request.user.location_id.id
    plan_idObj = request.user.location_id.activated_plan_id
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_incident_target_ip_table(request):
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_incident_target_mac_pie_chart(request):
    condition = request.GET.get('condition')
    location_id = request.user.location_id.id
    plan_idObj = request.user.location_id.activated_plan_id
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_incident_target_mac_table(request):
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_incident_target_port_pie_chart(request):
    condition = request.GET.get('condition')
    location_id = request.user.location_id.id
    plan_idObj = request.user.location_id.activated_plan_id
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_incident_target_port_table(request):
...
# 21 Card Name: Attack Count Details, Card Name: Target Host --only table
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_incident_freq_targetted_host(request):
    condition = request.GET.get('condition')
    past_time, current_time = calculate_start_end_time(condition)
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_incident_freq_attacker(request):
    condition = request.GET.get('condition')
    past_time, current_time = calculate_start_end_time(condition)
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_incident_attacked_service_details(request):
    condition = request.GET.get('condition')
    past_time, current_time = calculate_start_end_time(condition)
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_incident_ml_detected_threat(request):
    condition = request.GET.get('condition')
    location_id = request.user.location_id.id
    plan_idObj = request.user.location_id.activated_plan_id
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_incident_ml_detected_threat_table(request):
    threat_class_type = request.GET.get('type')
    if threat_class_type is None:
        return Response({"message_type": "d_not_f", "errors": "type_not_f"})    
    ...
    if threat_class_type in threat_class_type_dict:
        ...
        # sql query to get table data
        table_query = f"SELECT platform, type_of_threat, attacker_ip, attacker_mac, attack_timestamp, ids_threat_class, ids_threat_type, ml_threat_class, dl_threat_class, ml_accuracy, dl_accuracy, attacker_port, target_port, target_ip, geoip_city, geoip_country_name, geoip_asn_name FROM {indice_name}-* WHERE {threat_class_type_dict[threat_class_type]} = '{threat_class_name}' AND (attack_epoch_time >= {past_time} AND attack_epoch_time <= {current_time}) AND ids_threat_class IS NULL and ((ml_accuracy>{accuracy1} AND ml_accuracy<={accuracy2}) OR (dl_accuracy>{accuracy1} AND dl_accuracy<={accuracy2})) "+s1+s2+f" ORDER BY attack_epoch_time DESC limit 200000;"
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_incident_ml_map(request):
    condition = request.GET.get('condition')
    location_id = request.user.location_id.id
    plan_idObj = request.user.location_id.activated_plan_id
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_incident_ml_map_table(request):
    city_name = request.GET.get('geoip_city')
    if city_name is None:
        return Response({"message_type": "d_not_f", "errors": "geoip_city_not_found"})
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_incident_ml_cntry_bar(request):
    condition = request.GET.get('condition')
    location_id = request.user.location_id.id
    plan_idObj = request.user.location_id.activated_plan_id
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_incident_ml_cntry_bar_table(request):
    country_name = request.GET.get('geoip_country_name')
    if country_name is None:
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_incident_ml_asn_bar(request):
    condition = request.GET.get('condition')
    location_id = request.user.location_id.id
    plan_idObj = request.user.location_id.activated_plan_id
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_incident_ml_asn_table(request):
    asn_name = request.GET.get('geoip_asn_name')
    if asn_name is None:
        return Response({"message_type": "d_not_f", "errors": "geoip_asn_name_not_found"})
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_incident_ml_city_pie(request):
    condition = request.GET.get('condition')
    location_id = request.user.location_id.id
    plan_idObj = request.user.location_id.activated_plan_id
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_incident_ml_city_table(request):
    city_name = request.GET.get('geoip_city')
    if city_name is None:
        return Response({"message_type": "d_not_f", "errors": "geoip_city_not_found"})
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_incident_ml_target_ip_pie(request):
    condition = request.GET.get('condition')
    location_id = request.user.location_id.id
    plan_idObj = request.user.location_id.activated_plan_id
    ...
    sql = f"SELECT target_ip, COUNT(target_ip) FROM {indice_name}-* WHERE (attack_epoch_time >= {past_time} AND attack_epoch_time <= {current_time}) AND ids_threat_class IS NULL AND target_ip IS NOT NULL and ((ml_accuracy>{accuracy1} AND ml_accuracy<={accuracy2}) OR (dl_accuracy>{accuracy1} AND dl_accuracy<={accuracy2})) "+platform_query+s1+s2+f" GROUP BY target_ip ORDER BY COUNT(target_ip) desc LIMIT 7;"
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_incident_ml_target_ip_table(request):
    target_ip = request.GET.get('target_ip')
    if target_ip is None:
        return Response({"message_type": "d_not_f", "errors": "target_ip_not_found"})
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_incident_ml_target_mac_pie_chart(request):
    condition = request.GET.get('condition')
    location_id = request.user.location_id.id
    plan_idObj = request.user.location_id.activated_plan_id
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_incident_ml_target_mac_table(request):
    target_mac = request.GET.get('target_mac')
    if target_mac is None:
        return Response({"message_type": "d_not_f", "errors": "target_mac_not_found"})
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_incident_ml_target_port_pie(request):
    condition = request.GET.get('condition')
    location_id = request.user.location_id.id
    plan_idObj = request.user.location_id.activated_plan_id
    ...
    if run_sql_query.get("total") not in exclude_values:
        ...
        # for grouping according to platform
        sql2 = f"SELECT platform, target_port, count(target_port) target_port_count FROM {indice_name}-* WHERE (attack_epoch_time >= {past_time} AND attack_epoch_time <= {current_time}) AND ids_threat_class IS NULL and ((ml_accuracy>{accuracy1} AND ml_accuracy<={accuracy2}) OR (dl_accuracy>{accuracy1} AND dl_accuracy<={accuracy2})) "+platform_query+s1+s2+f" AND target_port IN {target_port_tuple} AND platform IS NOT NULL AND ids_threat_class IS NULL GROUP BY platform, target_port ORDER BY target_port_count desc;"
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_incident_ml_target_port_table(request):
    target_port = request.GET.get('target_port')
    if target_port is None:
        return Response({"message_type": "d_not_f", "errors": "target_port_not_found"})
...
# 32 ML DL-Card Name: Target Host --only table
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_incident_ml_freq_trgted_host(request):
    condition = request.GET.get('condition')
    past_time, current_time = calculate_start_end_time(condition)
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_incident_ml_freq_attacker(request):
    condition = request.GET.get('condition')
    past_time, current_time = calculate_start_end_time(condition)
...
# 34 ML DL- Card Name: Attacked Service --only table
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_incident_ml_attacked_service_details(request):
    condition = request.GET.get('condition')
    past_time, current_time = calculate_start_end_time(condition)
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def nids_incident_threat_type_ser_label(request):
    condition = request.GET.get('condition')
    location_id = request.user.location_id.id
    plan_idObj = request.user.location_id.activated_plan_id
