#  ==============================================================================================================================
#  File Name: trace_event.py
#  Description: It contains all the code for each chart on Trace Events page under Trace tab on Client Dashboard.
#  Active URL: https://xdr-demo.zerohack.in/trace/events
...
def critical_threats_trace_event(request):
    ...
    indice_name = index_name_dict.get('trace_event_agent')
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def critical_threats_table_trace_event(request):
    location_id = request.user.location_id.id
    plan_idObj = request.user.location_id.activated_plan_id
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def lateral_mov_trace_event(request):
    condition = request.GET.get('condition')
    location_id = request.user.location_id.id
    plan_idObj = request.user.location_id.activated_plan_id
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def lateral_mov_table_trace_event(request):
    location_id = request.user.location_id.id
    plan_idObj = request.user.location_id.activated_plan_id
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def int_compr_trace_event(request):
    condition = request.GET.get('condition')
    location_id = request.user.location_id.id
    plan_idObj = request.user.location_id.activated_plan_id
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def int_compr_table_trace_event(request):
    location_id = request.user.location_id.id
    plan_idObj = request.user.location_id.activated_plan_id
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def ext_table_trace_event(request):
    location_id = request.user.location_id.id
    plan_idObj = request.user.location_id.activated_plan_id
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def geolocation_trace_event(request):
    condition = request.GET.get('condition')
    location_id = request.user.location_id.id
    plan_idObj = request.user.location_id.activated_plan_id
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def geolocation_table_trace_event(request):
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def threat_type_count_trace_event(request):
    condition = request.GET.get('condition')
    location_id = request.user.location_id.id
    plan_idObj = request.user.location_id.activated_plan_id
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def attacker_port_pie_chart_trace_event(request):
    condition = request.GET.get('condition')
    location_id = request.user.location_id.id
    plan_idObj = request.user.location_id.activated_plan_id
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def attacker_port_pie_table_trace_event(request):
...
#8.a Card Name: Source  IPs (Line chart)
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def attacker_ip_line_chart_trace_event(request):
    condition = request.GET.get('condition')
    location_id = request.user.location_id.id
    plan_idObj = request.user.location_id.activated_plan_id
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def line_table_trace_event(request):
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def country_bar_chart_trace_event(request):
    condition = request.GET.get('condition')
    location_id = request.user.location_id.id
    plan_idObj = request.user.location_id.activated_plan_id
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def country_bar_table_trace_event(request):
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def city_pie_chart_trace_event(request):
    condition = request.GET.get('condition')
    location_id = request.user.location_id.id
    plan_idObj = request.user.location_id.activated_plan_id
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def city_pie_table_trace_event(request):
    city_name = request.GET.get('name')
    sensor_name = request.GET.get('name1')
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def asn_bar_chart_trace_event(request):
    condition = request.GET.get('condition')
    location_id = request.user.location_id.id
    plan_idObj = request.user.location_id.activated_plan_id
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def asn_bar_table_trace_event(request):
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def trget_ip_pie_chart_trace_event(request):
    condition = request.GET.get('condition')
    location_id = request.user.location_id.id
    plan_idObj = request.user.location_id.activated_plan_id
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def trget_ip_table_trace_event(request):
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def attacked_service_details_trace_event(request):
    condition = request.GET.get('condition')
    past_time, current_time = calculate_start_end_time(condition)
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def freq_attacker_trace_event(request):
    condition = request.GET.get('condition')
    past_time, current_time = calculate_start_end_time(condition)
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def brut_username_trace_event(request):
    condition = request.GET.get('condition')
    location_id = request.user.location_id.id
    plan_idObj = request.user.location_id.activated_plan_id
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def brut_password_trace_event(request):
    condition = request.GET.get('condition')
    location_id = request.user.location_id.id
    plan_idObj = request.user.location_id.activated_plan_id
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def trget_port_pie_chart_trace_event(request):
    condition = request.GET.get('condition')
    location_id = request.user.location_id.id
    plan_idObj = request.user.location_id.activated_plan_id
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def trget_port_table_trace_event(request):
