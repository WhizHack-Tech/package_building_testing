#  ==============================================================================================================================
#  File Name: trace_incident.py
#  Description: It contains all the code for each chart on Trace Incidents page under Trace tab on Client Dashboard.
#  Active URL: https://xdr-demo.zerohack.in/trace/incidents
...
def trace_incident_critical_threats(request):
    ...
    indice_name = index_name_dict.get('trace_incident_agent')
    ...
    # formatting sql_query query output as (key, value) pairs in dictionary
        ...
        if run_sql2.get("total") not in [0, None]:
            # sensor_name, type_of_threat, threat_count = map(list, zip(*run_sql2['datarows']))
            # formatting sql2 query output as (key, value) pairs in dictionary
            # print(f"type_of_threat list:{type_of_threat}, count:{threat_count}")

            # if "Internal Compromised Machine" not in type_of_threat:
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def trace_incident_critical_threats_table(request):
    location_id = request.user.location_id.id
    plan_idObj = request.user.location_id.activated_plan_id
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def trace_incident_lateral_mov(request):
    condition = request.GET.get('condition')
    location_id = request.user.location_id.id
    plan_idObj = request.user.location_id.activated_plan_id
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def trace_incident_lateral_mov_table(request):
    location_id = request.user.location_id.id
    plan_idObj = request.user.location_id.activated_plan_id
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def trace_incident_int_compr(request):
    condition = request.GET.get('condition')
    location_id = request.user.location_id.id
    plan_idObj = request.user.location_id.activated_plan_id
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def trace_incident_int_compr_table(request):
    location_id = request.user.location_id.id
    plan_idObj = request.user.location_id.activated_plan_id
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def trace_incident_ext(request):
    condition = request.GET.get('condition')
    location_id = request.user.location_id.id
    plan_idObj = request.user.location_id.activated_plan_id
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def trace_incident_ext_table(request):
    location_id = request.user.location_id.id
    plan_idObj = request.user.location_id.activated_plan_id
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def trace_incident_geolocation(request):
    condition = request.GET.get('condition')
    location_id = request.user.location_id.id
    plan_idObj = request.user.location_id.activated_plan_id
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def trace_incident_geolocation_table(request):
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def trace_incident_threat_type_count(request):
    condition = request.GET.get('condition')
    location_id = request.user.location_id.id
    plan_idObj = request.user.location_id.activated_plan_id
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def trace_incident_attacker_port_pie_chart(request):
    condition = request.GET.get('condition')
    location_id = request.user.location_id.id
    plan_idObj = request.user.location_id.activated_plan_id
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def trace_incident_attacker_port_pie_table(request):
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def trace_incident_attacker_ip_line_chart(request):
    condition = request.GET.get('condition')
    location_id = request.user.location_id.id
    plan_idObj = request.user.location_id.activated_plan_id
...
#8.b. Attacker IPs Table 
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def trace_incident_line_table(request):
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def trace_incident_country_bar_chart(request):
    condition = request.GET.get('condition')
    location_id = request.user.location_id.id
    plan_idObj = request.user.location_id.activated_plan_id
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def trace_incident_country_bar_table(request):
...
# 10.a Card Name: Top Source Attacker City (Pie chart on geoip_city column)
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def trace_incident_city_pie_chart(request):
    condition = request.GET.get('condition')
    location_id = request.user.location_id.id
    plan_idObj = request.user.location_id.activated_plan_id
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def trace_incident_city_pie_table(request):
    city_name = request.GET.get('name')
    sensor_name = request.GET.get('name1')
...
# 11.a Card Name: Top Source Attacker ASN (Bar chart on geoip_asn_name column)
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def trace_incident_asn_bar_chart(request):
    condition = request.GET.get('condition')
    location_id = request.user.location_id.id
    plan_idObj = request.user.location_id.activated_plan_id
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def trace_incident_asn_bar_table(request):
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def trace_incident_trget_ip_pie_chart(request):
    condition = request.GET.get('condition')
    location_id = request.user.location_id.id
    plan_idObj = request.user.location_id.activated_plan_id
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def trace_incident_trget_ip_table(request):
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def trace_incident_attacked_service_details(request):
    condition = request.GET.get('condition')
    past_time, current_time = calculate_start_end_time(condition)
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def trace_incident_freq_attacker(request):
    condition = request.GET.get('condition')
    past_time, current_time = calculate_start_end_time(condition)
...
# 15.a Card Name: Bruteforce Username
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def trace_incident_brut_username(request):
    condition = request.GET.get('condition')
    location_id = request.user.location_id.id
    plan_idObj = request.user.location_id.activated_plan_id
...
# 16.a. Card Name: Bruteforce Password
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def trace_incident_brut_password(request):
    condition = request.GET.get('condition')
    location_id = request.user.location_id.id
    plan_idObj = request.user.location_id.activated_plan_id
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def trace_incident_trget_port_pie_chart(request):
    condition = request.GET.get('condition')
    location_id = request.user.location_id.id
    plan_idObj = request.user.location_id.activated_plan_id
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def trace_incident_trget_port_table(request):
