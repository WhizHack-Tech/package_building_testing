// ================================================================================================
//  File Name: clientLogs.js
//  Description: Details of the Administration ( Client Log Details ).
//  ----------------------------------------------------------------------------------------------
...
const ClientLogs = () => {
  ...
  function logApi(limit, offset = 0) {
    setLoading(true)
    axios.get(`/client-logs?limit=${limit}&offset=${offset}`,
  ...
  useEffect(() => {
    document.querySelector(".logClientScrollRef").addEventListener('scroll', handleScroll, { passive: true })
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle tag='h5' className="mt-0 mb-0">Client User Logs</CardTitle>
      ...
      <hr className='m-0' />
      <div className='scroll-box logClientScrollRef p-0'>
