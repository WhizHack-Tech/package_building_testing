...
const EmailConfig = ({ stateParent, dispatchParent, repeateOneId }) => {
    // ** State
    ...
    function handleParentChange(event, i) {
        ...
        stateParent.data[repeateOneId].filters.email_filters[`child_node_${i}`].name = event.target.value
    }
                        ...
                        <Row className='justify-content-between align-items-end'>
                            ...
                            <Col md={6} className='mb-md-0 mb-1'>
                                <FormGroup>
                                    ...
                                    <MultipleOptions filterTypes='email_filters' stateParent={stateParent} repeateOneId={repeateOneId} childId={i} options={(state.selectedVals[i] !== undefined) ? state.selectedVals[i] : []} />
                                </FormGroup>
                            </Col>
                            <Col md={2}>
