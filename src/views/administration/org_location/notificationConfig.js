// ================================================================================================
//  File Name: notificationConfig.js
...
const NotificationConfig = ({ stateParent, dispatchParent, repeateOneId }) => {
    // ** State
    ...
    function handleParentChange(event, i) {
        ...
        stateParent.data[repeateOneId].filters.notification_filters[`child_node_${i}`].name = event.target.value
    }
    ...
    const deleteForm = e => {
        ...
        dispatchParent({
            type: "NOTIFICATION_DELETE_CHILD",
                        ...
                        <Row className='justify-content-between align-items-end'>
                            ...
                            <Col md={6} className='mb-md-0 mb-1'>
                                <FormGroup>
                                    ...
                                    <MultipleOptions filterTypes='notification_filters' stateParent={stateParent} repeateOneId={repeateOneId} childId={i} options={(state.selectedVals[i] !== undefined) ? state.selectedVals[i] : []} />
                                </FormGroup>
                            </Col>
                            <Col md={2}>
