...
const SoarSensor = () => {
    ...
    const apiCall = () => {
        setApiLoading(true)
        axios.get(`/display-soar-sensor-details?location_id=${id}&activated_plan_id=${activated_plan_id}`, { headers: { Authorization: token() } }).then(res => {
    ...
    const lisenceUpdateForm = (event) => {
        ...
        axios({
            method: 'post',
            url: `/display-soar-sensor-details?activated_plan_id=${activated_plan_id}`,
            data: bodyFormData,
            ...
            {apiLoading ? (
                ...
                <Form onSubmit={lisenceUpdateForm}>
                    <Row>
                        ...
                        <Col sm='3'>
                            ...
                            <Input type='select' name='xdr_soar_status'>
                                ...
                                <option value="active" selected disabled>{apiData.xdr_soar_status || ''}</option>
                    ...
                    <Col sm='3'>
                        ...
                        <Input type='select' name='xdr_hids_manager_status' defaultValue={apiData.control_server_domain || ''}>

                            <option value="active" selected disabled>{apiData.control_server_domain || ''}</option>
                        ...
                        <Col sm='3'>
                            ...
                            <Input type='text' name='soar_sensor_host_url' defaultValue={apiData.soar_sensor_host_url || ''} />
                        ...
                        {/* <Col sm='3'>
                            ...
                            <Input type='text' name='preferred_int' defaultValue={apiData.preferred_int || ''} />
                        ...
                        <Col sm='3'>
                            ...
                            <Input type='text' name='backend_port' defaultValue={apiData.backend_port || ''} />
                        ...
                        <Col sm='3'>
                            ...
                            <Input type='text' name='frontend_port' defaultValue={apiData.frontend_port || ''} />
                        ...
                        <Col sm='3'>
                            ...
                            <Input type='text' name='frontend_port_https' defaultValue={apiData.frontend_port_https || ''} />
                        ...
                        <Col sm='3'>
                            ...
                            <Input type='text' name='shuffle_default_username' defaultValue={apiData.shuffle_default_username || ''} />
                        ...
                        <Col sm='3'>
                            ...
                            <Input type='text' name='shuffle_default_password' defaultValue={apiData.shuffle_default_password || ''} />
                        ...
                        <Col sm='3'>
                            ...
                            <Input type='text' name='shuffle_default_apikey' defaultValue={apiData.shuffle_default_apikey || ''} />
