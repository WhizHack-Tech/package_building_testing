...
const UserAccountTab = ({ selectedUser }) => {
  ...
  useEffect(() => {
    if (selectedUser !== null || (selectedUser !== null && data !== null && selectedUser.organization_id !== data.organization_id)) {
            ...
            <Row>
              <Col md='4' sm='12'>
                <FormGroup>
                  ...
                  <Input type='text' id='organization_name' placeholder='Username' defaultValue={data.organization_name} />
                </FormGroup>
              </Col>
              <Col md='4' sm='12'>
                <FormGroup>
                  <Label for='name'>Name</Label>
                  <Input type='text' id='organization_name' placeholder='Name' defaultValue={data.organization_name} />
                </FormGroup>
              </Col>
              <Col md='4' sm='12'>
                <FormGroup>
                  <Label for='email'>Email</Label>
                  <Input type='text' id='organization_name' placeholder='Email' defaultValue={data.organization_name} />
                </FormGroup>
              </Col>
              <Col md='4' sm='12'>
                <FormGroup>
                  <Label for='status'>Status</Label>
                  <Input type='select' name='organization_name' id='organization_name' defaultValue={data.organization_name}>
