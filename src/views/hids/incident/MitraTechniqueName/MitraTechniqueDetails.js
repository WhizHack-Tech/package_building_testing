// ================================================================================================
//  File Name: MitraTechniqueDEtails.js
//  Description: Details of the HIDS Incident Graph (Mitra Technique Details).
//  ----------------------------------------------------------------------------------------------
...
const TopAttackedCount = () => {
    ...
    const DetailsApiLogic = () => {
        setApiLoader(true)
        axios.get(`/incident-hids-techniq-table?past_time=${searchParams.get('past_time')}&current_time=${searchParams.get('current_time')}&name=${searchParams.get('name')}&name1=${searchParams.get('name1')}&name2=${searchParams.get('name2')}`, { headers: { Authorization: token() } })
            .then(res => {
                setApiLoader(false)
    ...
    const columnsName = [
        ...
        //     name: t('Rule Nist'),
        //     sortable: true,
        //     selector: row => row.rule_nist_800_53,
        //     minWidth: '100px'
        // },
        // {
        //     name: t('Rule PCI DSS'),
    ...
    return (
        <Card className='overflow-hidden'>
             <CardHeader className='flex-md-row flex-column align-md-items-center align-items-start border-bottom'>
                <CardTitle tag='h4'> {t("Mitre Att&ck Techniques")} : {searchParams.get("name")}</CardTitle>
