// ================================================================================================
//  File Name: index.js
//  Description: Details of the Trace ( Alerts ( Bruteforce Password Details )).
//  ----------------------------------------------------------------------------------------------
...
const WordCloudChart = () => {
  ...
  useEffect(() => {
    ...
    axios.get(`/trace-alert-brut-passwrd?condition=${filterState.values ? filterState.values : 'last_1_hour'}`, { headers: { Authorization: token() } })
      .then((res) => {
        setIsLoading(false)
  ...
  return (
    <Fragment>
      <Card>
        <CardHeader>
          <CardTitle tag='h4'>{t('Bruteforce Password')}</CardTitle>
        </CardHeader>
        <CardBody>
          {
            checkApiData ? (
